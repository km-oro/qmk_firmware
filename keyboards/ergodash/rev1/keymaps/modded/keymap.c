...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
  [_QWERTY] = LAYOUT( \
    KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_LBRC,                        KC_RBRC, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    JA_ENVL, \
    KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_MINS,                        KC_EQL , KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    JA_AT, \
    KC_TAB,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_DEL ,                        KC_BSPC, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, \
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_GRV,                         KC_GRV,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_UP,   JA_ENUN, \
    KC_LCTL, KC_LGUI, KC_LALT, KC_HOME,          LOWER,   KC_SPC ,KC_SPC,          KC_ENT,KC_ENT, RAISE,             KC_SLSH, KC_LEFT, KC_DOWN, KC_RGHT  \
  ),
